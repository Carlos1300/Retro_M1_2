...
accuracy = round(metrics.accuracy_score(y_test, y_pred_tuned),2)*100
print("The accuracy of the tuned model is: %s" %(accuracy), "%")

cmat = metrics.confusion_matrix(y_test, y_pred_tuned)
